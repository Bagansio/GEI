...
bool cmp (Estudiant o, Estudiant i)
{
    if (o.consultar_nota() == i.consultar_nota())
    {
        return o.consultar_DNI() < i.consultar_DNI();
    }
    else return o.consultar_nota() > i.consultar_nota();
}
